...
def main():
    ...
    if args.dataset == 'cifar10':
        ...
        train_labeled_set, train_unlabeled_set, test_set = get_cifar10('/home/aailab/yund02/ML/data', N_SAMPLES_PER_CLASS,
                                                                               U_SAMPLES_PER_CLASS, args.out)
        print('##################################')
        print(f'Labeled data의 수: {len(train_labeled_set)}')
        print(train_labeled_set[0])
        print(f'data shape: {train_labeled_set[0][0].shape}')
        print('##################################')
        print(f'Unlabeled data의 수: {len(train_unlabeled_set)}')
        print(train_unlabeled_set[0])
        print(len(train_unlabeled_set[0][0]))
        print(f'data shape: {train_unlabeled_set[0][0][0].shape}')
        print('##################################')
        print(f'Test data의 수: {len(test_set)}')
        print(test_set[0])
        print(f'data shape: {test_set[0][0].shape}')
        print('##################################')
    elif args.dataset == 'stl10':
        print(f'==> Preparing imbalanced STL-10')
        train_labeled_set, train_unlabeled_set, test_set = get_stl10('/home/aailab/yund02/ML/data', N_SAMPLES_PER_CLASS, args.out)
    elif args.dataset == 'cifar100':
        print(f'==> Preparing imbalanced CIFAR-100')
        train_labeled_set, train_unlabeled_set, test_set = get_cifar100('/home/aailab/yund02/ML/data', N_SAMPLES_PER_CLASS,
                                                                                U_SAMPLES_PER_CLASS, args.out)
