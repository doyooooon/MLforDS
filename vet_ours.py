...
from dataset import get_cifar10, get_cifar100, get_stl10, get_vetdata
...
def main():
    ...
    if args.dataset == 'vet':
        train_labeled_set, train_unlabeled_set, test_set = get_vetdata('/home/aailab/yund02/ML/data/bonedata',
                                                                        N_SAMPLES_PER_CLASS,
                                                                        U_SAMPLES_PER_CLASS,
                                                                        args.out)
